...
description: "Financial & Career - 55 verses on financial education principles"
...
.top-nav {
  background: linear-gradient(135deg, #f39c12 0%, #f39c12dd 100%);
...
.chapter-header::before {
  ...
  width: 200%;
  height: 200%;
  background: linear-gradient(45deg, transparent, #f39c1210, transparent);
...
.verse::before {
  ...
  right: 0;
  height: 2px;
  background: linear-gradient(90deg, #f39c12, #f39c1280, #f39c12);
  opacity: 0;
...
.progress-fill {
  height: 100%;
  background: linear-gradient(90deg, #f39c12, #f39c12cc, #f39c12);
...
@keyframes progressGlow {
  0% { box-shadow: 0 0 5px #f39c1280; }
  100% { box-shadow: 0 0 15px #f39c12cc; }
}
...
<div class="top-nav">
  <div class="nav-container">
    ...
    <div class="chapter-info">
      <p class="chapter-number">Chapter 53</p>
      <p class="chapter-title">Teaching Money</p>
    </div>
...
<div class="main-content">
  <div class="chapter-header">
    ...
    <h1 class="chapter-main-title">Chapter 53: Teaching Money</h1>
    <p class="chapter-description">Financial & Career • 55 verses on financial education principles</p>
  </div>

  <div class="verse">
<span class="verse-number">💫 Verse 1</span>
<p class="verse-text">Joa teaches that financial education principles requires understanding money as a tool for creating value and serving others effectively.</p>
</div>

<div class="verse">
<span class="verse-number">✨ Verse 2</span>
<p class="verse-text">The foundation of financial education principles rests on spending less than you earn while continuously increasing your earning capacity.</p>
</div>

<div class="verse">
<span class="verse-number">🌟 Verse 3</span>
<p class="verse-text">Successful financial education principles involves making decisions based on long-term consequences rather than immediate emotional impulses.</p>
</div>

<div class="verse">
<span class="verse-number">🎯 Verse 4</span>
<p class="verse-text">The practice of financial education principles includes regular tracking and analysis of financial data to guide future decisions.</p>
</div>

<div class="verse">
<span class="verse-number">💎 Verse 5</span>
<p class="verse-text">True financial education principles balances security and growth, taking calculated risks while protecting against catastrophic losses.</p>
</div>

<div class="verse">
<span class="verse-number">⭐ Verse 6</span>
<p class="verse-text">Joa emphasizes that financial education principles works best when aligned with your values and life goals rather than social expectations.</p>
</div>

<div class="verse">
<span class="verse-number">🌈 Verse 7</span>
<p class="verse-text">Advanced financial education principles involves understanding taxes, inflation, and economic cycles to make informed financial choices.</p>
</div>

<div class="verse">
<span class="verse-number">🔥 Verse 8</span>
<p class="verse-text">The art of financial education principles includes learning from financial mistakes while avoiding repeated errors through better systems.</p>
</div>

<div class="verse">
<span class="verse-number">💝 Verse 9</span>
<p class="verse-text">Ethical financial education principles considers the impact of financial decisions on family, community, and future generations.</p>
</div>

<div class="verse">
<span class="verse-number">🎨 Verse 10</span>
<p class="verse-text">Mastery of financial education principles enables you to help others improve their financial situations while maintaining your own stability.</p>
</div>
...
<div class="bottom-nav">
  <div class="bottom-nav-container">
    ...
    <div class="progress-info">
      <p class="progress-text">Chapter 53 of 72</p>
...
function prevChapter() {
  window.location.href = "../financial/chapter-52-financial-protection.html";
}
